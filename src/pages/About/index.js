...
function About() {
  ...
  <div className="aboutCardLeft">
        <p className="aboutText"><div className="aDemetro">Alyssa DeMetro</div> 
        <br></br>
        An Orlando Native, and a graduate of the University Of Central Florida Full-Stack Coding Bootcamp.</p>
        <p>I have a fundamental working knowledge of HTML, CSS, JavaScript, jQuery, Node.js, Express.js, MySQL, MongoDB, Mongoose, React.js, and more. I have experience working with diverse teams or independently to meet demanding deadlines. I am confident and capable of building fully functional MERN stack web applications from start to finish. I am passionate about continuing my education and learning new technologies, and I have the patience and research skills necessary to resolve issues independently.
